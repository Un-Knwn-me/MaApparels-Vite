...
const Girls = () => {
    ...
    useEffect(() => {
      const importImages = async () => {
        const imageContext = import.meta.glob("../assets/images/Girls/*");
        ...
        <div className='product'>
          <Container>
            <Grid container spacing={3} sx={{ pt: 5 }}>
              ...
              <Button variant="contained" onClick={()=>navigate('/kids/girls')} style={{ backgroundColor: '#F40B4B', width: '100%' }}>Girls</Button>
              </Grid>
            <Grid item xs={6} md={6} lg={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Button variant="outlined" onClick={()=>navigate('/kids/boys')} style={{ width: '100%', borderColor: '#F40B4B', color: '#F40B4B' }}>Boys</Button>
            </Grid>
