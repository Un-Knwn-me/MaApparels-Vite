...
const Boys = () => {
    ...
    useEffect(() => {
      const importImages = async () => {
        const imageContext = import.meta.glob("../assets/images/Boys/*");
      ...
      <Base>
        <div className='product'>
          <Container sx={{ pb: 10 }}>
            ...
            <Button variant="outlined" onClick={()=>navigate('/kids/girls')} style={{ width: '100%', borderColor: '#F40B4B', color: '#F40B4B' }}>Girls</Button>
            </Grid>
            <Grid item xs={6} md={6} lg={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Button variant="contained" onClick={()=>navigate('/kids/boys')} style={{ backgroundColor: '#F40B4B', width: '100%' }}>Boys</Button>
            </Grid>
