...
import { Card, CardActionArea, CardMedia, Container, Dialog, Grid, IconButton, Typography } from '@mui/material'
          ...
          <Container>
            <Grid container spacing={3} sx={{ pt: 5 }}>
              <Grid sx={{ mt: -3, mb: 2 }} item xs={12} md={12} lg={12}>
                <Typography style={{ fontWeight: 'bold', fontSize: '28px', justifyContent: 'center', display: 'flex', color: '#2F4858' }} variant='bullet'>Infant</Typography>
              </Grid>
                    ...
                    <Card sx={{ maxWidth: "100%" }}>
                      <CardActionArea onClick={() => handleClickOpen(index)}>
                        <CardMedia
                          ...
                          height="300"
                          src={image}
                          alt={`Infants' Fashion - Image ${index}`}
                        />
                        <div
                          style={{
                            position: "absolute",
