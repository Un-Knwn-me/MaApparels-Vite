        ...
        <div className='product'>
          <Container>
            <Grid container spacing={3} sx={{ pt: 5 }}>
              ...
              <Button variant="contained" onClick={()=>navigate('/women/casual')} style={{ backgroundColor: '#F40B4B', width: '100%' }}>Casual Wear</Button>
              </Grid>
            <Grid item xs={6} md={6} lg={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Button variant="outlined" onClick={()=>navigate('/women/freestyle')} style={{ width: '100%', borderColor: '#F40B4B', color: '#F40B4B' }}>Night Wear</Button>
            </Grid>
